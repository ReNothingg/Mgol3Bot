...
- Отправка работы: для фото можно приложить до 10 снимков, включая изображения, отправленные файлом, с пересылкой администраторам.
...
- Даты в админ-панели вводятся по МСК, формат: `ДД.ММ.ГГГГ ЧЧ:ММ`.
